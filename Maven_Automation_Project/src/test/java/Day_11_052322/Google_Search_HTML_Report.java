...
public class Google_Search_HTML_Report {
    ...
    public void SetChromeDriver(){
        // Calling the setDriver method from Reusable_Actions class.
    ...
    public void SearchForKeyword(){
        // Starting the test.
        // `logger` is a variable that is used to log the test steps.
    ...
    // Used to quit the driver and flush the report.
    @AfterSuite
