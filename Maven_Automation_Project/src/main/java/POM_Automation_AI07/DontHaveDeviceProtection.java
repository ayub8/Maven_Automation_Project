...
public class DontHaveDeviceProtection extends Reusable_Annotation_Class {
    ...
    public DontHaveDeviceProtection (WebDriver driver){
    ...
    WebElement SearchbyZIPorPostalCode;


    public void SearchbyZIPorPostalCode(){
        Reusable_Actions_POM_Loggers.clickAction(driver,SearchbyZIPorPostalCode,logger, "Search by ZIP or Postal Code");
    }//end of SearchbyZIPorPostalCode
}//end of the class
