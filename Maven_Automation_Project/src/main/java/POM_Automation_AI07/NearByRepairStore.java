...
public class NearByRepairStore extends Reusable_Annotation_Class {
    ...
    public NearByRepairStore (WebDriver driver){
    ...
    @FindBy(xpath = "//*[@href='https://www.cellphonerepair.com/astoria-long-island-ny/free-repair-estimate/']")
    WebElement RepairEstimate;


    public void RepairEstimate(){
        Reusable_Actions_POM_Loggers.clickAction(driver,RepairEstimate,logger, "Repair Estimate");
    }//end of RepairEstimate
}//end of the class
