...
public class Reusable_Actions_Loggers {
    ...
    public static String varifyTitle(WebDriver driver, String xpath, ExtentTest logger, String elementName)
    {
        WebDriverWait wait = new WebDriverWait(driver, 10);
        //delcaring the string that will match the title
        String Title = driver.getTitle();
        //matching the title with the tile
        if (Title.equals("Team Lead")) {
            System.out.println("Title matched");
            logger.log(LogStatus.PASS,"Title matched " + elementName);

        } else {
            System.out.println("This is the Actual-Title  " + Title);
            logger.log(LogStatus.FAIL,"This is the Actual-Title " + elementName + " " + Title);
